...
const Payment = () => {
  ...
  const handlePayment = async () => {
    ...
    try {
      ...
      const orderResponse = await fetch(`${process.env.REACT_APP_API_URL}/bookings/create-order`, {
        method: "POST",
        headers: {
      ...
      const options = {
        ...
        handler: async (response) => {
          try {
            const verifyResponse = await fetch(`${process.env.REACT_APP_API_URL}/bookings/verify-payment`, {
              method: "POST",
              headers: {
                "Content-Type": "application/json",
                Authorization: `Bearer ${token}`,
  ...
  const downloadPDF = async (orderId, token) => {
    ...
    try {
      const response = await axios.get(`${process.env.REACT_APP_API_URL}/bookings/generate-pdf/${orderId}`, {
