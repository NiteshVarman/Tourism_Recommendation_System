...
const DevotionalListings = () => {
    ...
    useEffect(() => {
        const fetchListings = async () => {
            try {
                const response = await fetch(`${process.env.REACT_APP_API_URL}/listings/devotional`);
                const data = await response.json();
                console.log("Data received:", data);
                setListings(data);
            } catch (error) {
                console.error("Error fetching devotional listings:", error);
            } finally {
                setLoading(false);
            }
        };
           ...
           <div className="place-container">
               ...
               {listings.length > 0 ? (
                   ...
                   <div className="empty-state">
                       ...
                       />
                       <h3>No Devotional Packages Found</h3>
                       <p>We couldn't find any Devotional tour packages at the moment.</p>
                       <button 
