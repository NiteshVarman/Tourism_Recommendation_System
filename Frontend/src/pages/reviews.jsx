...
const Reviews = () => {
    ...
    const fetchReviews = async () => {
        try {
            setLoading(true);
            const response = await axios.get(`${process.env.REACT_APP_API_URL}/reviews/${listingId}`);
            ...
            files.map(async (file) => {
                ...
                try {
                    const response = await axios.post(
                        `${process.env.REACT_APP_API_URL}/upload-review-image`,
                        formData,
    ...
    const handleRespond = async (reviewId) => {
        ...
        try {
            await axios.post(`${process.env.REACT_APP_API_URL}/reviews/${reviewId}/respond`, {
                name,
                comment
            });
    ...
    const handleUpvote = async (reviewId) => {
        try {
            await axios.put(`${process.env.REACT_APP_API_URL}/reviews/${reviewId}/upvote`);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            if (editId) {
                await axios.put(`${process.env.REACT_APP_API_URL}/reviews/${editId}`, reviewData);
                setEditId(null);
            } else {
                await axios.post(`${process.env.REACT_APP_API_URL}/reviews`, reviewData);
            }
